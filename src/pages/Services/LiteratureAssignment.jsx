...
const LiteratureAssignment = () => {
  ...
  const PriceCardData = [
    {
      ...
      'desc': 'Benefit from transparent and consistent pricing, with no hidden costs, for all your assignment of English literature needs.',
    ...
    },
    {
      ...
      'desc': 'We ensure each literature assignment is an original masterpiece, free from plagiarism and AI-generated content.',
      'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
        <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
        <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
        <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
    ...
    },
    {
      ...
      'desc': 'Our dedicated team is available around the clock to assist you with any queries or concerns.',
      'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
        <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
        <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
        <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
    ...
    },
    {
      ...
      'desc': 'Enjoy a seamless experience with our intuitive and personalized user interface.',
      'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
        <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
        <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
        <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
    ...
    },
    {
      ...
      'desc': 'Access a range of free services that others charge for, enhancing the value of your investment.',
      'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
        <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
        <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
        <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
    ...
    },
    {
      ...
      'desc': ' We are committed to your satisfaction and offer unlimited revisions until your requirements are met.',
      'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
        <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
        <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
        <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
  ...
  // faqs data 
  const faqData = [
    { question: 'What distinguishes your Literature Assignment Help service?', answer: 'Our service stands out for its commitment to quality, affordability, and expert assistance, ensuring each literature assignment is unique and tailored to your needs.' },
    { question: 'How can I get help with an assignment on English literature?', answer: 'Simply visit our website, submit your requirements, and our professional writers will provide you with custom, plagiarism-free English literature coursework help.' },
    { question: 'Do you offer guidance for BEGC 102 European classical literature assignments?', answer: 'Yes, our team specializes in European classical literature, offering comprehensive and reliable support for BEGC 102 assignments and coursework.' },
    { question: 'Can I receive assistance with literature review writing in the UK?', answer: 'Absolutely, our experts provide Literature Review Writing UK services, ensuring detailed analysis and critical insights for your reviews.' },
    { question: 'Are your literature assignment services affordable for UK students?', answer: 'Yes, we pride ourselves on offering Affordable Literature Assignment Writing Service UK, ensuring quality work within your budget.' },
    { question: 'What kind of support can I expect for my literature dissertation in the UK?', answer: 'Our Literature Dissertation Guidance UK service offers customized, in-depth support for your dissertation, from research to final editing.' },
    { question: 'How do you ensure the quality of online literature tutoring in the UK?', answer: 'Our Online Literature Tutoring in UK is conducted by experienced educators who provide personalized, interactive sessions tailored to your learning style and needs.' },
  ...
  return (
    <>
      ...
      <div class="header">
        <div className="upper">
          <div class="headerTop">
            <h3>Literature Assignment Help in UK: Academic Excellence Redefined</h3>
        ...
        <div class="headerLeft">
          <img src="./images/headerImg.png" alt="litrature-image" />
        </div>
      </div>
      ...
      <div className="myteam">
        <div className="topSection">
          <h3>Meet Our Esteemed Literature Experts</h3>
      ...
      <div className="price " id="pricing-section">
        <div className="pricTop">
          <h3>Why Choose Our Literature Assignment Help?</h3>
      ...
      <div className="faqs">
        <div className="faqTop">
          <h3>Frequently Asked Questions About Our Literature Assignment Help</h3>
      ...
      <div className="review">
        <div className="reviewTop">
          <h3>What Our Clients Say About Our Literature Assignment Help</h3>
          ...
          <div className="reviewSectDivScroll">
            ...
            {Reviews.map((item, index) => (
              <div className="reviewCard" key={index}>
                ...
                <div className="sect2">
                  <img src={`./images/Animal avatars/${item.image}`} alt="litrature-image" />
