    ...
    const PriceCardData = [
        {
            ...
            'desc': 'Enjoy our straightforward £6.99 per page pricing, ensuring affordability without hidden costs.',
        ...
        },
        {
            ...
            'desc': 'All papers are crafted with originality, free from plagiarism and AI-generated content, ensuring authenticity in every word.',
            'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
                <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
                <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
        ...
        },
        {
            ...
            'desc': 'Access your projects with ease using our smooth, intuitive user interface designed for your convenience.',
            'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
                <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
                <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
        ...
        },
        {
            ...
            'desc': 'With our commitment to your satisfaction, receive unlimited free revisions to ensure your paper meets all your requirements.',
            'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
                <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
                <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
    ...
    return (
        <>
            ...
            <div class="header">
                <div className="upper">
                    <div class="headerTop">
                        <h3>Research Papers Service in UK – Tailored Academic Support</h3>
                        <p>Empowering Students, Academic Professionals, and Researchers with Comprehensive and Customised Research Paper Assistance</p>
                    </div>
                        ...
                        <div id='serviceHeader' className="headerRight">
                            <div className="serviceHeaderRight">
                                ...
                                <div className="RightContentBottom">
                                    <p><strong>Benefits of Our Research Papers Service: </strong>Experience affordable, transparent pricing with our fixed-rate system. Benefit from our no-extra-cost policy for essential add-ons and receive free, detailed plagiarism and AI analysis reports for every paper.</p>
                                    <p><strong>Our Commitment to Quality: </strong>At My Perfect Writing, we uphold the highest standards of academic excellence. Each paper is meticulously crafted to meet your specific research needs, ensuring quality and integrity in every word.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="CrouselSection">
                    <div className="crousel">
                        <Carousel autoPlay={true} showDots={true} responsive={responsive} >
                            {lecturersData.researchPaper.map((lecturer, index) => (
            ...
            <div className="price " id="pricing-section">
                <div className="pricTop">
                    <h3>Why Choose Our Research Papers Service?</h3>
            ...
            <div className="faqs">
                <div className="faqTop">
                    <h3>Research Paper Writing Service FAQs</h3>
            ...
            <div className="review">
                <div className="reviewTop">
                    <h3>What Our Clients Say About Our Research Papers Service</h3>
