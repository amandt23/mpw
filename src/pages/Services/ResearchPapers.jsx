...
const LiteratureReview = () => {
    ...
    const ResearchPaperFaqs = faqs.research_paper_faqs;
    const ResearchPaperReview = reviews.research_paper_service;
    ...
    return (
        <>
            <Helmet>
              ...
              <title>Research Papers Service | Expert UK Academic Help</title>
      ...
      "acceptedAnswer": {
        ...
        "text": "We pride ourselves on offering affordable research paper writing services, ensuring accessibility and value for students across the UK."
            ...
            <div class="header">
                <div className="upper">
                    <div class="headerTop">
                        <h1>Research Papers Service in UK – Tailored Academic Support</h1>
...
<a href="https://myperfectwriting.co.uk/portal/public/login">
            ...
            <div className="faqs">
                <div className="faqTop">
                    <h2>Research Paper Writing Service FAQs</h2>
                    <p>Discover the expertise and precision behind our Professional work</p>
                    <FAQsSection faqs={ResearchPaperFaqs} /> 
                </div>
