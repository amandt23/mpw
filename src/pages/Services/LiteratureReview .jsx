    ...
    const PriceCardData = [
        {
            ...
            'desc': ' Benefit from our transparent fixed pricing at just £6.99/page, ensuring affordability without compromising quality.',
        ...
        },
        {
            ...
            'desc': 'Each literature review is uniquely crafted, free from plagiarism, and devoid of AI-generated content.',
            'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
                <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
                <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
  ...
  "aggregateRating": {
    ...
    "ratingCount": "60"
            ...
            <div class="header">
                <div className="upper">
                    <div class="headerTop">
                        <h3>Literature Review Service in UK - My Perfect Writing</h3>
            ...
            <div className="price " id="pricing-section">
                <div className="pricTop">
                    <h3>Why Choose Our Literature Review Service?</h3>
            ...
            <div className="faqs">
                <div className="faqTop">
                    <h3>Frequently Asked Questions About Our Literature Review Service</h3>
            ...
            <div className="review">
                <div className="reviewTop">
                    <h3>Client Testimonials - Our Literature Review Success Stories</h3>
                    ...
                    <div className="reviewSectDivScroll">
                        ...
                        {Reviews.map((item, index) => (
                            <div className="reviewCard" key={index}>
                                ...
                                <div className="sect2">
                                    <img src={`./images/Animal avatars/${item.image}`} alt="review-image" />
            ...
            <div className='writing'>
                ...
                <div className="wPdf">
                    <div className="leftText">
                        <h2>Understanding Academic Essays and Literature Reviews</h2>
                        <p>
                        ...
                        <h2>Introduction to Our Literature Review Service</h2>
                        <p>
                        ...
                        <h2>Why Literature Reviews are Crucial in Academic Success</h2>
                        <p>
                        ...
                        <h2>Our Expertise in Crafting Comprehensive Literature Reviews</h2>
                        <p>
                        ...
                        <h2>The Process: How We Approach Literature Review Writing</h2>
                        <p>
                        ...
                        <h2>Ensuring Quality and Depth in Our Reviews</h2>
                        <p>
                        ...
                        <h2>Customized Literature Reviews: Tailored to Your Academic Needs</h2>
                        <p>
                        ...
                        <h2>Adding Value Through Insightful Analysis</h2>
                        <p>
                        ...
                        <h2>Commitment to Academic Integrity and Ethical Writing</h2>
                        <p>
                        ...
                        <h2>Feedback, Continuous Learning, and Adaptation</h2>
                        <p>
                        ...
                        <h2>Enhancing Your Research with Professional Literature Reviews</h2>
                        <p>
