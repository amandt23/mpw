  ...
  const PriceCardData = [
    {
      ...
      'title': 'Fixed Pricing at £7.99/page',
  ...
  return (
    <>
      ...
      <div class="header">
        <div className="upper">
          <div class="headerTop">
            <h3>My Perfect Writing - Discussion Posts Writing Service in UK</h3>
                ...
                <div className="headerRightTop serviceHeaderTop">
                  <div className="serviceRightContents">
                    ...
                    <div className="rightContents">
                      ...
                      <p className='fixedP'>Fixed Pricing at £7.99/Page Regardless of Deadline</p>
                    </div>
                    <div className="rightContents">
      ...
      <div className="price " id="pricing-section">
        <div className="pricTop">
          <h3>Why Choose My Perfect Writing for Your Discussion Posts?</h3>
        ...
        <div className="priceBottom">
          ...
          <div className="priceRightCard">
            {/* <div className="card"> */}
            <h3>Essay Writing Service in <span className='priceRightCard-price'>£7.99/Page</span> - Including</h3>
