    ...
    const PriceCardData = [
        {
            ...
            'desc': 'Experience transparent pricing at just £6.99 per page, making quality dissertation services accessible.',
        ...
        },
        {
            ...
            'desc': 'Each dissertation is crafted with originality, free from plagiarism and AI-generated content.',
            'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
                <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
                <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
        ...
        },
        {
            ...
            'desc': 'Our commitment to your satisfaction is reflected in our policy of offering unlimited free revisions.',
            'icon2': <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                <path d="M17.2787 27.2421L15.8592 25.8226L24.2748 17.4069L15.8592 8.99129L17.2787 7.57178L27.1139 17.4069L17.2787 27.2421Z" fill="#01593A" />
                <path d="M8.45726 16.3926H25.6941V18.4204H8.45726V16.3926Z" fill="#01593A" />
                <path d="M17.5831 34.6434C8.05214 34.6434 0.346237 26.9375 0.346237 17.4066C0.346237 7.87558 8.05214 0.169678 17.5831 0.169678C27.1141 0.169678 34.82 7.87558 34.82 17.4066C34.82 26.9375 27.1141 34.6434 17.5831 34.6434ZM17.5831 2.19755C9.16747 2.19755 2.37411 8.99091 2.37411 17.4066C2.37411 25.8222 9.16747 32.6156 17.5831 32.6156C25.9988 32.6156 32.7921 25.8222 32.7921 17.4066C32.7921 8.99091 25.9988 2.19755 17.5831 2.19755Z" fill="#01593A" />
    ...
    return (
        <>
            ...
            <div class="header">
                <div className="upper">
                    <div class="headerTop">
                        <h3>Dissertation Writing Service in UK - My Perfect Writing</h3>
                        <p>Empowering Students, Academic Professionals, and Researchers with Premier Dissertation Support</p>
                    </div>
                        ...
                        <div id='serviceHeader' className="headerRight">
                            <div className="serviceHeaderRight">
                                ...
                                <div className="RightContentBottom">
                                    <p><strong>Why Choose Our Dissertation Writing Service?: </strong> Experience unparalleled value with our flat-rate pricing, comprehensive support, and commitment to academic integrity.</p>
                                    <p><strong>Our Commitment to Quality: </strong> At My Perfect Writing, quality is our cornerstone. We ensure each dissertation meets the highest academic standards.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="headerLeft">
                    <img src="./images/headerImg.png" alt="dissertation-image" />
                </div>
            </div>
            ...
            <div className="myteam">
                <div className="topSection">
                    <h3>Our Expert Dissertation Writers</h3>
