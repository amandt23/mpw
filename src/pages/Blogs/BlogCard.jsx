    ...
    return (
        ...
        <div className="blog-card">
            <div className="big-blog-Img">
                <img className='list-card-img' src="./images/blogcardImg.png" alt="" />
            </div>
            <div className="big-blog-desc list-card">
                <p>Lifestyle</p>
                <h2 className='list-card-head'>Movies to Watch for Halloween: The Ultimate Halloween Movie 2023 List</h2>
                ...
                <div className="list-read-more-button">
                    <Link className='Link' to='single-blog'>
