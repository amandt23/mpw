        ...
        <div className="singleBlog">
            ...
            <div className="singlBlogSection">
                ...
                <div className="singleBlogTop">
                    <h3>Write Some Thing Good: How to Professionally Write a Chemistry Lab Report</h3>
                    <p>In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to.</p>
                    <h2>“BUSINESS” </h2>
                    <img className='singleBlogImg' src="./images/blog1Img.png" alt="" />
                </div>
                ...
                <div className="singleBlogBottom">
                    ...
                    <div className="profileTop">
                        <h3>Written By</h3>
                        <img src="./images/blogProfile.png" alt="" />
                        <h2>Me Blacky</h2>
                    </div>
                    ...
                    {/* <div className="blogContents">
                        ...
                        <p>There are a few general things to keep in mind when writing a Ph.D. essay.
                            First, your essay should be clear and concise. It should get straight to the point without beating around the bush. Your main point should be well-defined.
                            Second, you need to make sure that your essay is well-organized and flows smoothly from start to finish. All paragraphs should be connected in some logical manner and should sound coherent.
                            Lastly, your essay should be free of errors. Errors can be grammatical, structural, and factual. You need to ensure that all types of errors are removed from your essay.

                            With these general things in mind, let's take a closer look at how to write a Ph.D. essay step by step.</p>
                    </div> */}
