                    ...
                    <div className="col-5">
                        <div className="article-left article-stick">
                            ...
                            <div className="article-media">
                                ...
                                <div className="icons">
                                <a className="social-icons" href={`https://twitter.com/intent/tweet?url=${url}`}>
