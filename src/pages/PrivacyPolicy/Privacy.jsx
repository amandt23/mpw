            ...
            <div className="termsMain">
                <div className="termsContents">
                    ...
                    <div className='termSection'>
                        ...
                        <p><strong>2.5 Website</strong><br /> The term "Website" refers exclusively to the online platform operated by MyPerfectWriting, accessible at <a href="https://www.myperfectwriting.co.uk">myperfectwriting.co.uk</a>.</p>
                        ...
                        <p>Your personal data is crucial in facilitating access to our services and fulfilling our contractual obligations. Upon registration, this data aids our experts in locating your profile to ensure seamless service delivery. Absence of such data hinders our capability to connect you with our experts and provide the intended functionality of our website.</p>
                        <p><strong>4.3 Payment Services:</strong></p>
                        <p>Our utilisation of third-party payment providers necessitates the provision of your payment and billing information. These transactions are safeguarded through encryption and other security protocols. For further details, kindly refer to our Refund Policy.</p>
                        <p><strong>4.4 Communications:</strong></p>
                        <p>We may initiate contact through various channels, including email, for service-related communications and feedback gathering. Opt-out options are available for such communications, with the exception of legal notices or essential user settings modifications on our website.</p>
                        <p><strong>4.5 Marketing and Promotion:</strong></p>
                        <p>We engage in data processing for marketing and promotional purposes, adhering to legal requirements and providing opt-out options for direct marketing communications. Your consent will be sought where necessary.</p>
                        <p><strong>4.6 Analytics and Development:</strong></p>
                        <p>We employ data analytics to enhance customer experience, develop new features, and improve our services. Participation in polls, surveys, and receipt of targeted advertising based on past interactions is subject to user preferences.</p>
                        <p><strong>4.7 Support and Legal Compliance:</strong></p>
                        <p>Data usage extends to dispute resolution, platform monitoring, legal compliance, and fraud prevention. We act in compliance with legal requirements and utilise data to safeguard the integrity of our platform.</p>
                        <p><strong>4.8 Data Archival and Contact Responses:</strong></p>
                        <p>For legal and communication purposes, we may archive data and use contact information provided by you when initiating contact with us.</p>
                        <p><strong>4.9 Safety and Security:</strong></p>
                        ...
                        <p>Processing may be conducted with your explicit consent.</p>
                        <p><strong>5.3 Contractual Necessity:</strong></p>
                        <p>Data processing may be essential for service provision in accordance with our <u>Terms and Conditions.</u></p>
                        <p><strong>5.4 Legitimate Interests:</strong></p>
                        <p>Processing may be necessary for our legitimate interests, including but not limited to, legal compliance, fraud prevention, and business efficiency assessment.</p>
                        <p><strong>5.5 Legal Compliance and Vital Interests:</strong></p>
                        ...
                        <ul>
                            ...
                            <li><strong>Advertisers and Intermediaries</strong>: We may, based on cookie information or other online identifiers, engage with advertisers and intermediaries in curating advertisements displayed on our Website. This engagement, however, is circumscribed by our commitment to your privacy.</li>
                        ...
                        <ul>
                            ...
                            <li><strong>Legitimate Interests</strong>: Data processed based on legitimate interests is retained until you object, or the data becomes irrelevant.</li>
                        ...
                        <ul>
                            ...
                            <li><strong>Right to Rectification</strong>: If your personal data is inaccurate or incomplete, you have the right to request corrections.</li>
                            <li><strong>Right to Erasure</strong>: You may request data deletion, subject to legal and other considerations.</li>
                            <li><strong>Right to Restrict Processing</strong>: You can request processing restriction under certain circumstances.</li>
                            <li><strong>Right to Data Portability</strong>: Where feasible, you have the right to data transfer between controllers.</li>
                            <li><strong>Right to Object</strong>: You may object to personal data processing based on public interest tasks or legitimate interests.</li>
                            <li><strong>Withdrawal of Consent</strong>: You can withdraw consent at any time, without affecting the lawfulness of processing based on consent before its withdrawal.</li>
                            <li><strong>Rights Related to Automated Decision-Making</strong>: You have rights concerning decisions based solely on automated processing.</li>
                        ...
                        <p>Engaging with the Company and utilising its services requires the voluntary submission of personal data. It is crucial to acknowledge that while individuals are under no obligation to provide such data, the creation of a user account and full utilisation of the Website's features is contingent on this data submission.</p>
                        <p><strong>Personal Data Controller</strong></p>
                        <p>The entity responsible for the control of personal data is <strong>My Perfect Writing Pvt. Ltd.</strong>, a company duly incorporated in accordance with the laws of United Kindgdom, and located at 124 City Road, London, United Kingdom, EC1V 2NX.</p>
                        ...
                        <p><strong>Email:</strong> <a href="https://www.myperfectwriting.co.uk">myperfectwriting.co.uk</a></p>
